...
export async function POST(req: NextRequest) {
  try {
    ...
    const scriptText = await geminiGenerateText(scriptPrompt, "You are a viral content creator specializing in dark luxury aesthetic. You only respond with JSON.");
